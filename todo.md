...
- [x] Add deterministic data and interaction coverage, then verify normal and Reduce Motion views on phone, tablet, and laptop.
- [x] Save a deployable checkpoint and synchronize the verified lodge-rescue update to GitHub.
...
## Cozy Block Studio Local Creations
...
## Parental Gate and Secure Parent Contact

- [x] Add an accessible math-based parental gate before entering Parent Settings, adult prompt controls, feedback, or support actions while retaining direct public access to `/privacy`.
