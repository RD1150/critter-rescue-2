...
const MEADOW_TASKS: TaskDef[] = [
  ...
  { type:'animalHomeMatch', critter:MEADOW_CRITTERS[2], scenarioText:'Daisy is helping four animal friends find their special places!', hintText:'Choose the cozy place that goes with each animal picture.', objectCount:4, difficulty:1, requiresOrder:false, introText:'Daisy brought four friendly animal pictures. Can you help each one find a cozy home or care place?' },
];
...
export const ZONES: ZoneInfo[] = [
  { id:'meadow', name:'Sunny Meadow', description:'A gentle clearing where little ones play', unlockHarmony:0, bgColors:['#87CEEB','#A8D8F0','#7EC8A0','#4A7A35','#3E6B2F'], missionTypes:['bridge','clearPath','memory','maze','tracing','counting','quietCount','letterSound','alliteration','syllableClap','sequence','shapeFit','colorMatch','sizeOrdering','critterPath','gardenSort','animalHomeMatch'], totalTasks:13, emoji:'🌸' },
