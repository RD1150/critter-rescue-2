...
const MEADOW_TASKS: TaskDef[] = [
  ...
  { type:'animalHomeMatch', critter:MEADOW_CRITTERS[2], scenarioText:'Daisy is helping six animal friends find their special places!', hintText:'Choose the cozy place that goes with each animal picture.', objectCount:6, difficulty:1, requiresOrder:false, introText:'Daisy brought six friendly animal pictures. Can you help each one find a cozy home or care place?' },
];
