...
describe('audio preferences', () => {
  ...
  it('persists spoken-direction, seasonal soundscape, and camp-theme preferences with the other audio settings', () => {
    const next = { voiceVolume: 0.4, captionsEnabled: false, spokenDirectionsEnabled: false, soundscapeEnabled: true, soundscapeVolume: 0.18, campTheme: 'winter' as const, largeIconMode: true, reduceMotion: true };
