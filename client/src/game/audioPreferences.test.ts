...
describe('audio preferences', () => {
  ...
  it('persists spoken-direction and seasonal soundscape preferences with the other audio settings', () => {
    const next = { voiceVolume: 0.4, captionsEnabled: false, spokenDirectionsEnabled: false, soundscapeEnabled: true, soundscapeVolume: 0.18, largeIconMode: true, reduceMotion: true };
