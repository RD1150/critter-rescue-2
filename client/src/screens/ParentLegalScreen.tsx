...
function PrivacyContent() {
  return <>
    ...
    <Section title="Services and sharing"><p>The game uses pre-generated voice and art assets delivered from the project’s secure hosting. It does not make real-time AI requests during child play and does not include third-party analytics, advertising tags, or external web-font requests. We do not sell child data or use child data for behavioral advertising.</p></Section>
