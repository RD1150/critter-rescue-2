...
describe('ParentSettingsScreen first-play tip', () => {
  it('offers brief grown-up co-play guidance without adding it to the child flow', () => {
    render(<ParentSettingsScreen onBack={vi.fn()} onOpenProgress={vi.fn()} onOpenGallery={vi.fn()} onOpenActivityGuide={vi.fn()} onOpenBuildPrompts={vi.fn()} onOpenParentInformation={vi.fn()} />);
